 ...
 * profile information.
 * Created by Emanuel Guerrero on 11/27/2015.
 */
public class ProfileFragmentActivity extends Fragment implements View.OnClickListener {
    ...
    private EditText trainerNameInputField;
    private EditText trainerCertificationNumberInputField;
    private EditText trainerInsuranceNumberInputField;
    ...
    private TextView trainerNameTextLabel;
    private TextView trainerCertificationNumberTextLabel;
    private TextView trainerInsuranceNumberTextLabel;
     ...
     * associated trainer if the user logged in is a client.
     */
    private AccountManager userAccountManager;
    private AccountManager trainerAccountManager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        trainerCertificationNumberInputField = (EditText) view.findViewById(R.id.
                                                                    trainerCertificationTextBox);
        trainerInsuranceNumberInputField = (EditText) view.findViewById(R.id.
                                                                    trainerInsuranceNumberTextBox);
        ...
        trainerCertificationNumberTextLabel = (TextView) view.findViewById(R.id.
                                                                    trainerCertificationTextLabel);
        trainerInsuranceNumberTextLabel = (TextView) view.findViewById(R.id.
    ...
    public void onDestroyView() {
        ...
        trainerNameInputField = null;
        trainerCertificationNumberInputField = null;
        trainerInsuranceNumberInputField = null;
        userCertificationNumberTextLabel = null;
        userInsuranceNumberTextLabel = null;
        yourTrainerTextLabel = null;
        trainerNameTextLabel = null;
        trainerCertificationNumberTextLabel = null;
        trainerInsuranceNumberTextLabel = null;
            ...
            case R.id.updateButton:
                ...
                if (userName.equals("") || passWord.equals("") || firstName.equals("") ||
                    ...
                    if (reasonForUse == 1) {
                        ...
                        //and the insurance number since the user is a trainer
                        try {
        ...
        protected String doInBackground(String... params) {
            ...
            if (reasonForUse == 1) {
                ...
                if (loadAccountStatus.equals("Account loaded!")) {
                    //Initialize the trainer account manager object with the trainer id of the client
                    //as the user id
                    trainerAccountManager = new AccountManager(userAccountManager.getTrainerID(), "",
                            "", "", "", 0, 0, 0, 0 ,0);
                    //Invoke the method to the loading the user's account but we are technically loading
                    //the trainer's account
                    //Store the JSON message in a variable
                    String loadTrainerAccountStatus = trainerAccountManager.loadAccount();
                    if (loadTrainerAccountStatus.equals("Account loaded!")) {
                        ...
                        activity.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                trainerNameInputField.setText(
                                        trainerAccountManager.getFirstName() +
                                                        " " + trainerAccountManager.getLastName());
                                trainerCertificationNumberInputField.setText(String.valueOf(
                                        trainerAccountManager.getCertificationNumber()));
                                trainerInsuranceNumberInputField.setText(String.valueOf(
                                        trainerAccountManager.getInsuranceNumber()));
